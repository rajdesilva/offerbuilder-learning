import { isParentOrChildrenPropertyAdded } from "../isParentOrChildrenPropertyAdded";

describe("isParentOrChildrenPropertyAdded function test", () => {
  test("isParentOrChildrenPropertyAdded check if clicked row added as parent or not when empty cart", () => {
    const clickedRow = {
  ...
  test("isParentOrChildrenPropertyAdded check if clicked row added as parent or not when filled cart has same parent", () => {
    const clickedRow = {
      img: "https://res.cloudinary.com/seekda-dev/image/upload/w_1920,h_1080,c_fill,f_auto,fl_lossy,q_auto/development/DEMO_JEEVAN/chambre_double_green_fullsize_ecodef-1140x760.jpg",
      images: [
        "https://res.cloudinary.com/seekda-dev/image/upload/w_1920,h_1080,c_fill,f_auto,fl_lossy,q_auto/development/DEMO_JEEVAN/chambre_double_green_fullsize_ecodef-1140x760.jpg",
    ...
    const selectedProperties = [
      ...
      {
        img: "https://res.cloudinary.com/seekda-dev/image/upload/w_1920,h_1080,c_fill,f_auto,fl_lossy,q_auto/development/DEMO_BANJARE/DUDE.jpg",
        images: [
