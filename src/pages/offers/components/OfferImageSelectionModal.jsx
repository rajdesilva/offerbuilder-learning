...
import { OfferImageGallery, OfferImageDetails } from ".";
import styles from "./css/OfferImageSelectionModal.module.less";
import isEqual from "lodash.isequal";

export default function OfferImageSelectionModal(props) {
  const intl = useIntl();
      ...
      <Fragment>
        ...
        <Row>
          <Col
            ...
            className={imageDetails.display ? styles.imgSelectionRow : ''}
          >
            <div className={styles.imageListContent}>
